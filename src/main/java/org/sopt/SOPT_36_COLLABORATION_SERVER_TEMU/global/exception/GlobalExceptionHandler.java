...
public class GlobalExceptionHandler {
    ...
    public BaseErrorResponse handleCustomExceptions(CustomException e) {
        log.error("[handle_CustomException]", e);
        return new BaseErrorResponse(e.getErrorCode(), HttpStatusCode.valueOf(e.getErrorCode().getHttpStatus()));
    }
}
